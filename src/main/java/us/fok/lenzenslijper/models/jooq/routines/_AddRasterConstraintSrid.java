...
public class _AddRasterConstraintSrid extends org.jooq.impl.AbstractRoutine<java.lang.Boolean> {

	private static final long serialVersionUID = 530113426;

	/**
	 * The parameter <code>public._add_raster_constraint_srid.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>public._add_raster_constraint_srid.rastschema</code>.
	 */
	...
	/**
	 * The parameter <code>public._add_raster_constraint_srid.rasttable</code>.
	 */
	...
	/**
	 * The parameter <code>public._add_raster_constraint_srid.rastcolumn</code>.
	 */
	 ...
	 */
	public _AddRasterConstraintSrid() {
		super("_add_raster_constraint_srid", us.fok.lenzenslijper.models.jooq.Public.PUBLIC, org.jooq.impl.SQLDataType.BOOLEAN);
	...
	public void setRastschema(java.lang.String value) {
		setValue(us.fok.lenzenslijper.models.jooq.routines._AddRasterConstraintSrid.RASTSCHEMA, value);
	}
	...
	public void setRasttable(java.lang.String value) {
		setValue(us.fok.lenzenslijper.models.jooq.routines._AddRasterConstraintSrid.RASTTABLE, value);
	}
	...
	public void setRastcolumn(java.lang.String value) {
		setValue(us.fok.lenzenslijper.models.jooq.routines._AddRasterConstraintSrid.RASTCOLUMN, value);
	}
