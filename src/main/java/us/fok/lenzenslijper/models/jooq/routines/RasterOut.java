...
public class RasterOut extends org.jooq.impl.AbstractRoutine<java.lang.Object> {

	private static final long serialVersionUID = -1752074233;

	/**
	 * The parameter <code>public.raster_out.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>public.raster_out._1</code>.
	 */
	 ...
	 */
	public RasterOut() {
		super("raster_out", us.fok.lenzenslijper.models.jooq.Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("cstring"));
	...
	public void set__1(java.lang.Object value) {
		setValue(us.fok.lenzenslijper.models.jooq.routines.RasterOut._1, value);
	}
