...
public class Box2dIn extends org.jooq.impl.AbstractRoutine<java.lang.Object> {

	private static final long serialVersionUID = -1913895290;

	/**
	 * The parameter <code>public.box2d_in.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>public.box2d_in._1</code>.
	 */
	 ...
	 */
	public Box2dIn() {
		super("box2d_in", us.fok.lenzenslijper.models.jooq.Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"));
	...
	public void set__1(java.lang.Object value) {
		setValue(us.fok.lenzenslijper.models.jooq.routines.Box2dIn._1, value);
	}
