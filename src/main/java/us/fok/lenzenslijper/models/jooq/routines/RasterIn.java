...
public class RasterIn extends org.jooq.impl.AbstractRoutine<java.lang.Object> {

	private static final long serialVersionUID = -369599500;

	/**
	 * The parameter <code>public.raster_in.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>public.raster_in._1</code>.
	 */
	 ...
	 */
	public RasterIn() {
		super("raster_in", us.fok.lenzenslijper.models.jooq.Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"));
	...
	public void set__1(java.lang.Object value) {
		setValue(us.fok.lenzenslijper.models.jooq.routines.RasterIn._1, value);
	}
