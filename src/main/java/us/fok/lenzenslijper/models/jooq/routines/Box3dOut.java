...
public class Box3dOut extends org.jooq.impl.AbstractRoutine<java.lang.Object> {

	private static final long serialVersionUID = 2045926391;

	/**
	 * The parameter <code>public.box3d_out.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>public.box3d_out._1</code>.
	 */
	 ...
	 */
	public Box3dOut() {
		super("box3d_out", us.fok.lenzenslijper.models.jooq.Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("cstring"));
	...
	public void set__1(java.lang.Object value) {
		setValue(us.fok.lenzenslijper.models.jooq.routines.Box3dOut._1, value);
	}
