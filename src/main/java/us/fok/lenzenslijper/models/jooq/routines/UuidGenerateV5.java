...
public class UuidGenerateV5 extends org.jooq.impl.AbstractRoutine<java.util.UUID> {
	...
	private static final long serialVersionUID = -467724394;
	...
	public UuidGenerateV5() {
		super("uuid_generate_v5", us.fok.lenzenslijper.models.jooq.Public.PUBLIC, org.jooq.impl.SQLDataType.UUID);
	...
	public void setNamespace(java.util.UUID value) {
		setValue(us.fok.lenzenslijper.models.jooq.routines.UuidGenerateV5.NAMESPACE, value);
	}
	...
	public void setName_(java.lang.String value) {
		setValue(us.fok.lenzenslijper.models.jooq.routines.UuidGenerateV5.NAME, value);
	}
