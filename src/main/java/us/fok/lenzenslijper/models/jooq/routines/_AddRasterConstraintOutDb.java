...
public class _AddRasterConstraintOutDb extends org.jooq.impl.AbstractRoutine<java.lang.Boolean> {

	private static final long serialVersionUID = 1523259269;

	/**
	 * The parameter <code>public._add_raster_constraint_out_db.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>public._add_raster_constraint_out_db.rastschema</code>.
	 */
	...
	/**
	 * The parameter <code>public._add_raster_constraint_out_db.rasttable</code>.
	 */
	...
	/**
	 * The parameter <code>public._add_raster_constraint_out_db.rastcolumn</code>.
	 */
	 ...
	 */
	public _AddRasterConstraintOutDb() {
		super("_add_raster_constraint_out_db", us.fok.lenzenslijper.models.jooq.Public.PUBLIC, org.jooq.impl.SQLDataType.BOOLEAN);
	...
	public void setRastschema(java.lang.String value) {
		setValue(us.fok.lenzenslijper.models.jooq.routines._AddRasterConstraintOutDb.RASTSCHEMA, value);
	}
	...
	public void setRasttable(java.lang.String value) {
		setValue(us.fok.lenzenslijper.models.jooq.routines._AddRasterConstraintOutDb.RASTTABLE, value);
	}
	...
	public void setRastcolumn(java.lang.String value) {
		setValue(us.fok.lenzenslijper.models.jooq.routines._AddRasterConstraintOutDb.RASTCOLUMN, value);
	}
