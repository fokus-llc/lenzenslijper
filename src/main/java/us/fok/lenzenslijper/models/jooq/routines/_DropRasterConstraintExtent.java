...
public class _DropRasterConstraintExtent extends org.jooq.impl.AbstractRoutine<java.lang.Boolean> {

	private static final long serialVersionUID = 1228611584;

	/**
	 * The parameter <code>public._drop_raster_constraint_extent.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>public._drop_raster_constraint_extent.rastschema</code>.
	 */
	...
	/**
	 * The parameter <code>public._drop_raster_constraint_extent.rasttable</code>.
	 */
	...
	/**
	 * The parameter <code>public._drop_raster_constraint_extent.rastcolumn</code>.
	 */
	 ...
	 */
	public _DropRasterConstraintExtent() {
		super("_drop_raster_constraint_extent", us.fok.lenzenslijper.models.jooq.Public.PUBLIC, org.jooq.impl.SQLDataType.BOOLEAN);
	...
	public void setRastschema(java.lang.String value) {
		setValue(us.fok.lenzenslijper.models.jooq.routines._DropRasterConstraintExtent.RASTSCHEMA, value);
	}
	...
	public void setRasttable(java.lang.String value) {
		setValue(us.fok.lenzenslijper.models.jooq.routines._DropRasterConstraintExtent.RASTTABLE, value);
	}
	...
	public void setRastcolumn(java.lang.String value) {
		setValue(us.fok.lenzenslijper.models.jooq.routines._DropRasterConstraintExtent.RASTCOLUMN, value);
	}
