...
public class _RasterConstraintInfoPixelTypes extends org.jooq.impl.AbstractRoutine<java.lang.String[]> {

	private static final long serialVersionUID = -1444729649;

	/**
	 * The parameter <code>public._raster_constraint_info_pixel_types.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>public._raster_constraint_info_pixel_types.rastschema</code>.
	 */
	...
	/**
	 * The parameter <code>public._raster_constraint_info_pixel_types.rasttable</code>.
	 */
	...
	/**
	 * The parameter <code>public._raster_constraint_info_pixel_types.rastcolumn</code>.
	 */
	 ...
	 */
	public _RasterConstraintInfoPixelTypes() {
		super("_raster_constraint_info_pixel_types", us.fok.lenzenslijper.models.jooq.Public.PUBLIC, org.jooq.impl.SQLDataType.CLOB.getArrayDataType());
	...
	public void setRastschema(java.lang.String value) {
		setValue(us.fok.lenzenslijper.models.jooq.routines._RasterConstraintInfoPixelTypes.RASTSCHEMA, value);
	}
	...
	public void setRasttable(java.lang.String value) {
		setValue(us.fok.lenzenslijper.models.jooq.routines._RasterConstraintInfoPixelTypes.RASTTABLE, value);
	}
	...
	public void setRastcolumn(java.lang.String value) {
		setValue(us.fok.lenzenslijper.models.jooq.routines._RasterConstraintInfoPixelTypes.RASTCOLUMN, value);
	}
