...
public class _AddRasterConstraintPixelTypes extends org.jooq.impl.AbstractRoutine<java.lang.Boolean> {

	private static final long serialVersionUID = -1910994103;

	/**
	 * The parameter <code>public._add_raster_constraint_pixel_types.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>public._add_raster_constraint_pixel_types.rastschema</code>.
	 */
	...
	/**
	 * The parameter <code>public._add_raster_constraint_pixel_types.rasttable</code>.
	 */
	...
	/**
	 * The parameter <code>public._add_raster_constraint_pixel_types.rastcolumn</code>.
	 */
	 ...
	 */
	public _AddRasterConstraintPixelTypes() {
		super("_add_raster_constraint_pixel_types", us.fok.lenzenslijper.models.jooq.Public.PUBLIC, org.jooq.impl.SQLDataType.BOOLEAN);
	...
	public void setRastschema(java.lang.String value) {
		setValue(us.fok.lenzenslijper.models.jooq.routines._AddRasterConstraintPixelTypes.RASTSCHEMA, value);
	}
	...
	public void setRasttable(java.lang.String value) {
		setValue(us.fok.lenzenslijper.models.jooq.routines._AddRasterConstraintPixelTypes.RASTTABLE, value);
	}
	...
	public void setRastcolumn(java.lang.String value) {
		setValue(us.fok.lenzenslijper.models.jooq.routines._AddRasterConstraintPixelTypes.RASTCOLUMN, value);
	}
