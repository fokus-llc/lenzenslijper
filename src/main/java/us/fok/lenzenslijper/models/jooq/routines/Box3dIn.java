...
public class Box3dIn extends org.jooq.impl.AbstractRoutine<java.lang.Object> {

	private static final long serialVersionUID = 2020568388;

	/**
	 * The parameter <code>public.box3d_in.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>public.box3d_in._1</code>.
	 */
	 ...
	 */
	public Box3dIn() {
		super("box3d_in", us.fok.lenzenslijper.models.jooq.Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"));
	...
	public void set__1(java.lang.Object value) {
		setValue(us.fok.lenzenslijper.models.jooq.routines.Box3dIn._1, value);
	}
