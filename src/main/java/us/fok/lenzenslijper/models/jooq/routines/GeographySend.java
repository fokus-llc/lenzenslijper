...
public class GeographySend extends org.jooq.impl.AbstractRoutine<byte[]> {

	private static final long serialVersionUID = -514062931;
	...
	/**
	 * The parameter <code>public.geography_send._1</code>.
	 */
	...
	public GeographySend() {
		super("geography_send", us.fok.lenzenslijper.models.jooq.Public.PUBLIC, org.jooq.impl.SQLDataType.BLOB);
	...
	public void set__1(java.lang.Object value) {
		setValue(us.fok.lenzenslijper.models.jooq.routines.GeographySend._1, value);
	}
