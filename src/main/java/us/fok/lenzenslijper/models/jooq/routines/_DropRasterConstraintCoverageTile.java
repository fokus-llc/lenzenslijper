...
public class _DropRasterConstraintCoverageTile extends org.jooq.impl.AbstractRoutine<java.lang.Boolean> {

	private static final long serialVersionUID = -687488485;

	/**
	 * The parameter <code>public._drop_raster_constraint_coverage_tile.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>public._drop_raster_constraint_coverage_tile.rastschema</code>.
	 */
	...
	/**
	 * The parameter <code>public._drop_raster_constraint_coverage_tile.rasttable</code>.
	 */
	...
	/**
	 * The parameter <code>public._drop_raster_constraint_coverage_tile.rastcolumn</code>.
	 */
	 ...
	 */
	public _DropRasterConstraintCoverageTile() {
		super("_drop_raster_constraint_coverage_tile", us.fok.lenzenslijper.models.jooq.Public.PUBLIC, org.jooq.impl.SQLDataType.BOOLEAN);
	...
	public void setRastschema(java.lang.String value) {
		setValue(us.fok.lenzenslijper.models.jooq.routines._DropRasterConstraintCoverageTile.RASTSCHEMA, value);
	}
	...
	public void setRasttable(java.lang.String value) {
		setValue(us.fok.lenzenslijper.models.jooq.routines._DropRasterConstraintCoverageTile.RASTTABLE, value);
	}
	...
	public void setRastcolumn(java.lang.String value) {
		setValue(us.fok.lenzenslijper.models.jooq.routines._DropRasterConstraintCoverageTile.RASTCOLUMN, value);
	}
