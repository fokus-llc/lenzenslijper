...
public class Box3dtobox extends org.jooq.impl.AbstractRoutine<java.lang.Object> {

	private static final long serialVersionUID = 1650664644;

	/**
	 * The parameter <code>public.box3dtobox.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>public.box3dtobox._1</code>.
	 */
	 ...
	 */
	public Box3dtobox() {
		super("box3dtobox", us.fok.lenzenslijper.models.jooq.Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("box"));
	...
	public void set__1(java.lang.Object value) {
		setValue(us.fok.lenzenslijper.models.jooq.routines.Box3dtobox._1, value);
	}
