...
public class _DropRasterConstraintPixelTypes extends org.jooq.impl.AbstractRoutine<java.lang.Boolean> {

	private static final long serialVersionUID = 1700131283;

	/**
	 * The parameter <code>public._drop_raster_constraint_pixel_types.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>public._drop_raster_constraint_pixel_types.rastschema</code>.
	 */
	...
	/**
	 * The parameter <code>public._drop_raster_constraint_pixel_types.rasttable</code>.
	 */
	...
	/**
	 * The parameter <code>public._drop_raster_constraint_pixel_types.rastcolumn</code>.
	 */
	 ...
	 */
	public _DropRasterConstraintPixelTypes() {
		super("_drop_raster_constraint_pixel_types", us.fok.lenzenslijper.models.jooq.Public.PUBLIC, org.jooq.impl.SQLDataType.BOOLEAN);
	...
	public void setRastschema(java.lang.String value) {
		setValue(us.fok.lenzenslijper.models.jooq.routines._DropRasterConstraintPixelTypes.RASTSCHEMA, value);
	}
	...
	public void setRasttable(java.lang.String value) {
		setValue(us.fok.lenzenslijper.models.jooq.routines._DropRasterConstraintPixelTypes.RASTTABLE, value);
	}
	...
	public void setRastcolumn(java.lang.String value) {
		setValue(us.fok.lenzenslijper.models.jooq.routines._DropRasterConstraintPixelTypes.RASTCOLUMN, value);
	}
