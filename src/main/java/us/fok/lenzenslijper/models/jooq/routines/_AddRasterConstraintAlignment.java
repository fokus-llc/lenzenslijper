...
public class _AddRasterConstraintAlignment extends org.jooq.impl.AbstractRoutine<java.lang.Boolean> {

	private static final long serialVersionUID = -391448076;

	/**
	 * The parameter <code>public._add_raster_constraint_alignment.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>public._add_raster_constraint_alignment.rastschema</code>.
	 */
	...
	/**
	 * The parameter <code>public._add_raster_constraint_alignment.rasttable</code>.
	 */
	...
	/**
	 * The parameter <code>public._add_raster_constraint_alignment.rastcolumn</code>.
	 */
	 ...
	 */
	public _AddRasterConstraintAlignment() {
		super("_add_raster_constraint_alignment", us.fok.lenzenslijper.models.jooq.Public.PUBLIC, org.jooq.impl.SQLDataType.BOOLEAN);
	...
	public void setRastschema(java.lang.String value) {
		setValue(us.fok.lenzenslijper.models.jooq.routines._AddRasterConstraintAlignment.RASTSCHEMA, value);
	}
	...
	public void setRasttable(java.lang.String value) {
		setValue(us.fok.lenzenslijper.models.jooq.routines._AddRasterConstraintAlignment.RASTTABLE, value);
	}
	...
	public void setRastcolumn(java.lang.String value) {
		setValue(us.fok.lenzenslijper.models.jooq.routines._AddRasterConstraintAlignment.RASTCOLUMN, value);
	}
