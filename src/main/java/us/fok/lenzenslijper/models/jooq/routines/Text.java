...
public class Text extends org.jooq.impl.AbstractRoutine<java.lang.String> {

	private static final long serialVersionUID = 1459965402;

	/**
	 * The parameter <code>public.text.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>public.text._1</code>.
	 */
	 ...
	 */
	public Text() {
		super("text", us.fok.lenzenslijper.models.jooq.Public.PUBLIC, org.jooq.impl.SQLDataType.CLOB);
	...
	public void set__1(java.lang.Object value) {
		setValue(us.fok.lenzenslijper.models.jooq.routines.Text._1, value);
	}
