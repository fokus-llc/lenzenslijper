...
public class GeometrySend extends org.jooq.impl.AbstractRoutine<byte[]> {

	private static final long serialVersionUID = -160041151;
	 ...
	 */
	public GeometrySend() {
		super("geometry_send", us.fok.lenzenslijper.models.jooq.Public.PUBLIC, org.jooq.impl.SQLDataType.BLOB);
	...
	public void set__1(java.lang.Object value) {
		setValue(us.fok.lenzenslijper.models.jooq.routines.GeometrySend._1, value);
	}
