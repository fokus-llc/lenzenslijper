...
public class _RasterConstraintInfoCoverageTile extends org.jooq.impl.AbstractRoutine<java.lang.Boolean> {

	private static final long serialVersionUID = 470245529;

	/**
	 * The parameter <code>public._raster_constraint_info_coverage_tile.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>public._raster_constraint_info_coverage_tile.rastschema</code>.
	 */
	...
	/**
	 * The parameter <code>public._raster_constraint_info_coverage_tile.rasttable</code>.
	 */
	...
	/**
	 * The parameter <code>public._raster_constraint_info_coverage_tile.rastcolumn</code>.
	 */
	 ...
	 */
	public _RasterConstraintInfoCoverageTile() {
		super("_raster_constraint_info_coverage_tile", us.fok.lenzenslijper.models.jooq.Public.PUBLIC, org.jooq.impl.SQLDataType.BOOLEAN);
	...
	public void setRastschema(java.lang.String value) {
		setValue(us.fok.lenzenslijper.models.jooq.routines._RasterConstraintInfoCoverageTile.RASTSCHEMA, value);
	}
	...
	public void setRasttable(java.lang.String value) {
		setValue(us.fok.lenzenslijper.models.jooq.routines._RasterConstraintInfoCoverageTile.RASTTABLE, value);
	}
	...
	public void setRastcolumn(java.lang.String value) {
		setValue(us.fok.lenzenslijper.models.jooq.routines._RasterConstraintInfoCoverageTile.RASTCOLUMN, value);
	}
