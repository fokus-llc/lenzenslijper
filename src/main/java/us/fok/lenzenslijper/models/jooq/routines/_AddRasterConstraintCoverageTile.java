...
public class _AddRasterConstraintCoverageTile extends org.jooq.impl.AbstractRoutine<java.lang.Boolean> {

	private static final long serialVersionUID = 366373159;

	/**
	 * The parameter <code>public._add_raster_constraint_coverage_tile.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>public._add_raster_constraint_coverage_tile.rastschema</code>.
	 */
	...
	/**
	 * The parameter <code>public._add_raster_constraint_coverage_tile.rasttable</code>.
	 */
	...
	/**
	 * The parameter <code>public._add_raster_constraint_coverage_tile.rastcolumn</code>.
	 */
	 ...
	 */
	public _AddRasterConstraintCoverageTile() {
		super("_add_raster_constraint_coverage_tile", us.fok.lenzenslijper.models.jooq.Public.PUBLIC, org.jooq.impl.SQLDataType.BOOLEAN);
	...
	public void setRastschema(java.lang.String value) {
		setValue(us.fok.lenzenslijper.models.jooq.routines._AddRasterConstraintCoverageTile.RASTSCHEMA, value);
	}
	...
	public void setRasttable(java.lang.String value) {
		setValue(us.fok.lenzenslijper.models.jooq.routines._AddRasterConstraintCoverageTile.RASTTABLE, value);
	}
	...
	public void setRastcolumn(java.lang.String value) {
		setValue(us.fok.lenzenslijper.models.jooq.routines._AddRasterConstraintCoverageTile.RASTCOLUMN, value);
	}
