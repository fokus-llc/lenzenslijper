...
public class _DropRasterConstraintSrid extends org.jooq.impl.AbstractRoutine<java.lang.Boolean> {

	private static final long serialVersionUID = 1712318816;

	/**
	 * The parameter <code>public._drop_raster_constraint_srid.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>public._drop_raster_constraint_srid.rastschema</code>.
	 */
	...
	/**
	 * The parameter <code>public._drop_raster_constraint_srid.rasttable</code>.
	 */
	...
	/**
	 * The parameter <code>public._drop_raster_constraint_srid.rastcolumn</code>.
	 */
	 ...
	 */
	public _DropRasterConstraintSrid() {
		super("_drop_raster_constraint_srid", us.fok.lenzenslijper.models.jooq.Public.PUBLIC, org.jooq.impl.SQLDataType.BOOLEAN);
	...
	public void setRastschema(java.lang.String value) {
		setValue(us.fok.lenzenslijper.models.jooq.routines._DropRasterConstraintSrid.RASTSCHEMA, value);
	}
	...
	public void setRasttable(java.lang.String value) {
		setValue(us.fok.lenzenslijper.models.jooq.routines._DropRasterConstraintSrid.RASTTABLE, value);
	}
	...
	public void setRastcolumn(java.lang.String value) {
		setValue(us.fok.lenzenslijper.models.jooq.routines._DropRasterConstraintSrid.RASTCOLUMN, value);
	}
