...
public class Box2dfIn extends org.jooq.impl.AbstractRoutine<java.lang.Object> {

	private static final long serialVersionUID = 522919028;

	/**
	 * The parameter <code>public.box2df_in.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>public.box2df_in._1</code>.
	 */
	 ...
	 */
	public Box2dfIn() {
		super("box2df_in", us.fok.lenzenslijper.models.jooq.Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"));
	...
	public void set__1(java.lang.Object value) {
		setValue(us.fok.lenzenslijper.models.jooq.routines.Box2dfIn._1, value);
	}
