...
public class Box2dfOut extends org.jooq.impl.AbstractRoutine<java.lang.Object> {

	private static final long serialVersionUID = 374383647;

	/**
	 * The parameter <code>public.box2df_out.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>public.box2df_out._1</code>.
	 */
	 ...
	 */
	public Box2dfOut() {
		super("box2df_out", us.fok.lenzenslijper.models.jooq.Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("cstring"));
	...
	public void set__1(java.lang.Object value) {
		setValue(us.fok.lenzenslijper.models.jooq.routines.Box2dfOut._1, value);
	}
