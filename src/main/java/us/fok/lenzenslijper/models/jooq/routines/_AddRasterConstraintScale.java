...
public class _AddRasterConstraintScale extends org.jooq.impl.AbstractRoutine<java.lang.Boolean> {

	private static final long serialVersionUID = -2033934106;

	/**
	 * The parameter <code>public._add_raster_constraint_scale.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>public._add_raster_constraint_scale.rastschema</code>.
	 */
	...
	/**
	 * The parameter <code>public._add_raster_constraint_scale.rasttable</code>.
	 */
	...
	/**
	 * The parameter <code>public._add_raster_constraint_scale.rastcolumn</code>.
	 */
	...
	/**
	 * The parameter <code>public._add_raster_constraint_scale.axis</code>.
	 */
	 ...
	 */
	public _AddRasterConstraintScale() {
		super("_add_raster_constraint_scale", us.fok.lenzenslijper.models.jooq.Public.PUBLIC, org.jooq.impl.SQLDataType.BOOLEAN);
	...
	public void setRastschema(java.lang.String value) {
		setValue(us.fok.lenzenslijper.models.jooq.routines._AddRasterConstraintScale.RASTSCHEMA, value);
	}
	...
	public void setRasttable(java.lang.String value) {
		setValue(us.fok.lenzenslijper.models.jooq.routines._AddRasterConstraintScale.RASTTABLE, value);
	}
	...
	public void setRastcolumn(java.lang.String value) {
		setValue(us.fok.lenzenslijper.models.jooq.routines._AddRasterConstraintScale.RASTCOLUMN, value);
	}
	...
	public void setAxis(java.lang.String value) {
		setValue(us.fok.lenzenslijper.models.jooq.routines._AddRasterConstraintScale.AXIS, value);
	}
