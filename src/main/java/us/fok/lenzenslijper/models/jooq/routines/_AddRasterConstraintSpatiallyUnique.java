...
public class _AddRasterConstraintSpatiallyUnique extends org.jooq.impl.AbstractRoutine<java.lang.Boolean> {

	private static final long serialVersionUID = -818843317;

	/**
	 * The parameter <code>public._add_raster_constraint_spatially_unique.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>public._add_raster_constraint_spatially_unique.rastschema</code>.
	 */
	...
	/**
	 * The parameter <code>public._add_raster_constraint_spatially_unique.rasttable</code>.
	 */
	...
	/**
	 * The parameter <code>public._add_raster_constraint_spatially_unique.rastcolumn</code>.
	 */
	 ...
	 */
	public _AddRasterConstraintSpatiallyUnique() {
		super("_add_raster_constraint_spatially_unique", us.fok.lenzenslijper.models.jooq.Public.PUBLIC, org.jooq.impl.SQLDataType.BOOLEAN);
	...
	public void setRastschema(java.lang.String value) {
		setValue(us.fok.lenzenslijper.models.jooq.routines._AddRasterConstraintSpatiallyUnique.RASTSCHEMA, value);
	}
	...
	public void setRasttable(java.lang.String value) {
		setValue(us.fok.lenzenslijper.models.jooq.routines._AddRasterConstraintSpatiallyUnique.RASTTABLE, value);
	}
	...
	public void setRastcolumn(java.lang.String value) {
		setValue(us.fok.lenzenslijper.models.jooq.routines._AddRasterConstraintSpatiallyUnique.RASTCOLUMN, value);
	}
