...
public class _RasterConstraintInfoOutDb extends org.jooq.impl.AbstractRoutine<java.lang.Boolean[]> {

	private static final long serialVersionUID = 1484890811;

	/**
	 * The parameter <code>public._raster_constraint_info_out_db.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>public._raster_constraint_info_out_db.rastschema</code>.
	 */
	...
	/**
	 * The parameter <code>public._raster_constraint_info_out_db.rasttable</code>.
	 */
	...
	/**
	 * The parameter <code>public._raster_constraint_info_out_db.rastcolumn</code>.
	 */
	 ...
	 */
	public _RasterConstraintInfoOutDb() {
		super("_raster_constraint_info_out_db", us.fok.lenzenslijper.models.jooq.Public.PUBLIC, org.jooq.impl.SQLDataType.BOOLEAN.getArrayDataType());
	...
	public void setRastschema(java.lang.String value) {
		setValue(us.fok.lenzenslijper.models.jooq.routines._RasterConstraintInfoOutDb.RASTSCHEMA, value);
	}
	...
	public void setRasttable(java.lang.String value) {
		setValue(us.fok.lenzenslijper.models.jooq.routines._RasterConstraintInfoOutDb.RASTTABLE, value);
	}
	...
	public void setRastcolumn(java.lang.String value) {
		setValue(us.fok.lenzenslijper.models.jooq.routines._RasterConstraintInfoOutDb.RASTCOLUMN, value);
	}
