...
public class Box2dOut extends org.jooq.impl.AbstractRoutine<java.lang.Object> {

	private static final long serialVersionUID = 1293767579;

	/**
	 * The parameter <code>public.box2d_out.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>public.box2d_out._1</code>.
	 */
	 ...
	 */
	public Box2dOut() {
		super("box2d_out", us.fok.lenzenslijper.models.jooq.Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("cstring"));
	...
	public void set__1(java.lang.Object value) {
		setValue(us.fok.lenzenslijper.models.jooq.routines.Box2dOut._1, value);
	}
